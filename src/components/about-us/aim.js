        ...
        <div class="flex flex-wrap items-center ">
          <div class="w-full px-4 mb-10 lg:w-1/2 lg:mb-0">
            <div class="lg:max-w-md">
              ...
              <h2 class="mt-4 mb-6 text-2xl font-bold dark:text-black">
                We are the large business expert in Europe and Asia
              </h2>
              <p class="mb-10 text-gray-800">
          ...
          <div class="w-full px-4 mb-10 lg:w-1/2 lg:mb-0">
            <div class="flex mb-4">
              <span class="flex items-center justify-center flex-shrink-0 w-12 h-12 mr-6 bg-primary rounded text-white">
                <svg
              ...
              <div>
                <h2 class="mb-4 text-xl font-bold leading-tight text-primary md:text-2xl">
                  Vission
                </h2>
